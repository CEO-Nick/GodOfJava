...
//        sample.checkUpperLower();
    ...
    public void checkAddress(String[] addresses) {
        ...
        for (String addr:addresses) {
            startCount += addr.startsWith(startText) ? 1 : 0;
            endCount += addr.endsWith(endText) ? 1 : 0;
        }
    ...
    public void containsAddress(String[] addresses) {
        ...
        for (String addr : addresses) {
            containCount += addr.contains(containText) ? 1 : 0;
        }
    ...
    public void checkLastIndexOf() {
        String text = "Java technology is both a programming language and a platform.";
        System.out.println(text.lastIndexOf('a'));  //56
        System.out.println(text.lastIndexOf("a ")); //52
        System.out.println(text.lastIndexOf('a', 20)); //39
    ...
    public void checkReplace() {
        ...
        String result1 = "The String clazz reprezentz character ztringz.";
        String result2 = "The|Strike|clazz|reprezentz|character|ztrikez.";
